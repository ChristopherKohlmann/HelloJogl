...
public class HelloTriangleSimple implements GLEventListener, KeyListener {
    ...
    private class Program {
        ...
        Program(GL3 gl, Class context, String root, String vertex, String fragment) {
            ...
            ShaderCode vertShader = ShaderCode.create(gl, GL_VERTEX_SHADER, this.getClass(), root, vertex, "vert", true);
            ShaderCode fragShader = ShaderCode.create(gl, GL_FRAGMENT_SHADER, this.getClass(), root, fragment, "frag", true);
//
...
//                    "frag", true);
//
//            ShaderCode s = ShaderCode.create(gl, GL_VERTEX_SHADER, this.getClass(), root, null, "vert", true);
